...
function App() {
	...
	return (
		<main className='App'>
			...
			<Routes>
				<Route path='/events/create' element={<EventSetupPage userID={user["_id"]} />} />
				<Route path='/events/:eventId/tasks/new' element={<TaskSetupPage setTasks={setTasks} tasks={tasks} />} />
