          ...
          element={
            <UserTimeout user={user} setUser={setUser}>
              ...
              <Routes>
                <Route
                  path="/dashboard"
                  element={<EventOverviewPage setUser={setUser} />}
                />
                <Route path="/user" element={<MyEventsPage />} />
                <Route
                  path="/events/create"
                  element={
                    <EventSetupPage userID={user["_id"]} setUser={setUser} />
                  }
                />
                <Route
                  path="/events/edit/:eventId"
                  element={
                    <EventSetupPage setTasks={setTasks} setUser={setUser} />
                  }
                />
                <Route
                  path="/events/:eventId"
                  element={
                    <EventDetailsPage setTasks={setTasks} setUser={setUser} />
                  }
                />
                <Route
